...
export const projects: Project[] = [
  ...
  { id: 'p2', name: 'Green Campus App', team: 'Design Team', progress: 60, icon: 'G', accent: '#17c987', members: ['D', 'B', 'C'] },
  { id: 'p3', name: 'Marketing Website', team: 'Marketing Team', progress: 40, icon: 'M', accent: '#ffb547', members: ['S', 'L'] },
  { id: 'p4', name: 'School Management', team: 'Development Team', progress: 90, icon: 'S', accent: '#3388ff', members: ['S', 'D', 'B'] },
  { id: 'p5', name: 'Research Assistant', team: 'AI Team', progress: 55, icon: 'R', accent: '#a855f7', members: ['S', 'C'] },
];

export const tasks: Task[] = [
  { id: 'MKT-101', title: 'Draft launch campaign brief', description: 'Outline the launch message, target audience, channels, and success metrics for the CollabAI marketing website.', status: 'todo', priority: 'medium', assignee: 'Lina', reporter: 'Seoul', dueDate: 'May 20, 2026', project: 'Marketing Website', tags: ['Campaign'], comments: 3, subtasks: [{ title: 'Define audience segments', done: true }, { title: 'Write channel plan', done: false }] },
  { id: 'MKT-102', title: 'Prepare social media content calendar', description: 'Create two weeks of posts for product launch, feature education, and team collaboration tips.', status: 'todo', priority: 'low', assignee: 'Pisey', reporter: 'Dara', dueDate: 'May 24, 2026', project: 'Marketing Website', tags: ['Social'], comments: 1, subtasks: [{ title: 'Draft post themes', done: false }, { title: 'Review captions', done: false }] },
  { id: 'MKT-103', title: 'Design hero section for landing page', description: 'Create a polished first viewport that clearly explains CollabAI for project teams.', status: 'in_progress', priority: 'high', assignee: 'Dara', reporter: 'Seoul', dueDate: 'May 19, 2026', project: 'Marketing Website', tags: ['Design'], comments: 5, subtasks: [{ title: 'Create layout options', done: true }, { title: 'Refine CTA states', done: false }] },
  { id: 'MKT-104', title: 'Review pricing page copy', description: 'Make the pricing copy simple, credible, and easy to understand for a school project presentation.', status: 'review', priority: 'medium', assignee: 'Bora', reporter: 'Lina', dueDate: 'May 21, 2026', project: 'Marketing Website', tags: ['Content'], comments: 2, subtasks: [{ title: 'Check feature wording', done: true }, { title: 'Proofread final copy', done: false }] },
  { id: 'MKT-105', title: 'Publish testimonial section', description: 'Add concise sample testimonials that show how teams use CollabAI to plan and deliver projects.', status: 'done', priority: 'low', assignee: 'Seoul', reporter: 'Dara', dueDate: 'May 14, 2026', project: 'Marketing Website', tags: ['Website'], comments: 0, subtasks: [{ title: 'Add testimonial cards', done: true }] },
